...
tag:
	docker tag lucasrgoes/adonis:current lucasrgoes/adonis:4.1-node.14.15.5
	...
	docker tag lucasrgoes/adonis:current-alpine lucasrgoes/adonis:4.1-node.14.15.5-alpine
...
push:
	@docker login
	docker push lucasrgoes/adonis:4.1-node.14.15.5
	...
	docker push lucasrgoes/adonis:4.1-node.14.15.5-alpine
