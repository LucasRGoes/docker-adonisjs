...
tag:
	docker tag lucasrgoes/adonis:current lucasrgoes/adonis:4.1-node.12.16.2
	docker tag lucasrgoes/adonis:current lucasrgoes/adonis:4.1-node.12.16
	...
	docker tag lucasrgoes/adonis:current-alpine lucasrgoes/adonis:4.1-node.12.16.2-alpine
	docker tag lucasrgoes/adonis:current-alpine lucasrgoes/adonis:4.1-node.12.16-alpine
